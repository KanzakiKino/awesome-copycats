...
theme.icon_dir                                  = os.getenv("HOME") .. "/.config/awesome/themes/kinok/icons"
...
theme.wallpaper = function (s)
    if s.index == 1 then
        return os.getenv("HOME") .. "/.config/awesome/themes/kinok/wall.png";
    else
        return os.getenv("HOME") .. "/.config/awesome/themes/kinok/wall2.png";
    end
end
...
-- ALSA volume bar
local volume_icon = wibox.widget.imagebox(theme.mpdl);
